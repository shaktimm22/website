   ...
   const starCountRef = ref(database, 'bus_owner_details/'+ queryString + '/gstin_details');

   onValue(starCountRef, (snapshot) => {
   const data = snapshot.val();

   document.getElementById('gstin').innerHTML = data.gstin;
   document.getElementById('have_ac_bus').innerHTML = data.have_ac_bus;
});
